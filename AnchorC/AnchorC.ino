...
// 깜빡임 속도 조절을 위한 blink_rate 변수
uint16_t blink_rate = 200;  // 기본 깜빡임 속도 설정

// 앵커와 태그 간의 거리 측정 결과 저장 변수
double range_self;
...
void setup() {
    ...
    DW1000Ng::setDeviceAddress(3);        // Anchor C의 주소 설정
...
void transmitRangeReport() {
    ...
    DW1000Ng::getDeviceAddress(&rangingReport[7]);  // Anchor C의 주소
